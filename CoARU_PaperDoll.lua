...
local TIPS = {
    ...
    TIP_QUEST_LOG_OPEN         = "Щёлкните здесь или нажмите |cffFFFF00L|r, чтобы открыть журнал заданий",
    TIP_QUEST_LOG_TRACK        = "Щёлкните здесь, чтобы отслеживать выбранное задание",
    TIP_QUEST_POI_GO_TO        = "Отправляйтесь в эту область",
    TIP_SPELLBOOK_OPEN         = "Щёлкните здесь или нажмите |cffFFFF00P|r, чтобы открыть книгу заклинаний",
    TIP_USE_ABILITIES          = "Чтобы применить способность, нажмите цифру, указанную на её значке",
    ...
    HELP_TIP_UNSPENT_ESSENCE_CUSTOM_CLASS_TEXT  = "У вас есть нераспределённые очки!",
    HELP_TIP_UNSPENT_ESSENCE_DEFAULT_CLASS_TEXT = "У вас есть нераспределённые очки талантов!",
    ...
    TIP_SHOW_MINIMAP_MAIL      = "Этот значок означает, что вам пришла почта! Заберите её у почтового ящика.\n\nНайти ближайший поможет значок с лупой слева от миникарты.",

    TIP_UNANSWERED_PLAYER_POLL_QUESTIONS = "В опросе остались вопросы без ответа!|nЩёлкните и выскажитесь о будущем Ascension!",
